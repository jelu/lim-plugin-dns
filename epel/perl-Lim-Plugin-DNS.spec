...
install -m 644 %{_builddir}/lim/html/_dns/zone_list.html %{buildroot}%{_datadir}/lim/html/_dns/zone_list.html
install -m 644 %{_builddir}/lim/html/_dns/opt_read.html %{buildroot}%{_datadir}/lim/html/_dns/opt_read.html
install -m 644 %{_builddir}/lim/html/_dns/rr_read.html %{buildroot}%{_datadir}/lim/html/_dns/rr_read.html
install -m 644 %{_builddir}/lim/html/_dns/zone_read.html %{buildroot}%{_datadir}/lim/html/_dns/zone_read.html
install -m 644 %{_builddir}/lim/html/_dns/rr_delete.html %{buildroot}%{_datadir}/lim/html/_dns/rr_delete.html
install -m 644 %{_builddir}/lim/html/_dns/opt_delete.html %{buildroot}%{_datadir}/lim/html/_dns/opt_delete.html
install -m 644 %{_builddir}/lim/html/_dns/rr_list.html %{buildroot}%{_datadir}/lim/html/_dns/rr_list.html
install -m 644 %{_builddir}/lim/html/_dns/index.html %{buildroot}%{_datadir}/lim/html/_dns/index.html
install -m 644 %{_builddir}/lim/html/_dns/zone_create.html %{buildroot}%{_datadir}/lim/html/_dns/zone_create.html
install -m 644 %{_builddir}/lim/html/_dns/about.html %{buildroot}%{_datadir}/lim/html/_dns/about.html
install -m 644 %{_builddir}/lim/html/_dns/rr_update.html %{buildroot}%{_datadir}/lim/html/_dns/rr_update.html
install -m 644 %{_builddir}/lim/html/_dns/zone_delete.html %{buildroot}%{_datadir}/lim/html/_dns/zone_delete.html
install -m 644 %{_builddir}/lim/html/_dns/js/application.js %{buildroot}%{_datadir}/lim/html/_dns/js/application.js
install -m 644 %{_builddir}/lim/html/_dns/zone_update.html %{buildroot}%{_datadir}/lim/html/_dns/zone_update.html
install -m 644 %{_builddir}/lim/html/_dns/rr_create.html %{buildroot}%{_datadir}/lim/html/_dns/rr_create.html
install -m 644 %{_builddir}/lim/html/_dns/opt_create.html %{buildroot}%{_datadir}/lim/html/_dns/opt_create.html
install -m 644 %{_builddir}/lim/html/_dns/opt_update.html %{buildroot}%{_datadir}/lim/html/_dns/opt_update.html
install -m 644 %{_builddir}/lim/html/_dns/opt_list.html %{buildroot}%{_datadir}/lim/html/_dns/opt_list.html
